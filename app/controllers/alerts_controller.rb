class AlertsController < ApplicationController
  ...
  def check
    ...
    @message = "Probabilmente hai più di un account su eiresis e non sei autenticato con quello a cui è destinata la notifica<br/>Esci ed entra con l'account corretto."
