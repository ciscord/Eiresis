class eiresis.ProposalVotationManager
  constructor: ->
  ...
  _initVoteButton: ->
    $('.votebutton').on 'click', ->
      ...
      message = if type == eiresis.i18n.proposals.vote.positive then eiresis.i18n.proposals.vote.confirm_positive else if type == eiresis.i18n.proposals.vote.neutral then eiresis.i18n.proposals.vote.confirm_neutral else eiresis.i18n.proposals.vote.confirm_negative
      if confirm(message)
