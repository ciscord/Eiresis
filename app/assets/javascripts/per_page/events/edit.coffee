window.EventsEdit =
  ...
  initClientSideValidation: ->
    new eiresisFormValidation($('#edit_event_' + EventsEdit.eventId))
  initMunicipalityInput: ->
  ...
  initMapManager: =>
    if EventsEdit.placeDefined
      ...
      EventsEdit.mapManager = new eiresis.MapManager('edit_map_canvas', latlng, center, @zoom)
    else
      EventsEdit.mapManager = new eiresis.MapManager('edit_map_canvas')
