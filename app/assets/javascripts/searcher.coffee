  ...
  constructor: ->
    ...
    search_f.data('uiAutocomplete')._renderItem = (ul, item) ->
      ...
      if item.type == 'Blog'
        ...
        text_.append '<div class="groupDescription"><img src="' + eiresis.assets.group_participants + '"><span class="count">' + item.participants_num + '</span></div>'
        text_.append '<div class="groupDescription"><img src="' + eiresis.assets.group_proposals + '"><span class="count">' + item.proposals_num + '</span></div>'
