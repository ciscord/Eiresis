...
echo " |  |_____ | | '__/ _ \\/ __| / __|"
echo " |  |_____ | | |  __/\\__ \\ \\__ \\"
echo " |_________|_|_|  \\___||___/_|___/"
echo "           Scegli di partecipare"
echo ""
echo "=====Welcome in eiresis Setup====="
echo "=================================="
echo ""
echo "We'll ask you some information to help you configure your eiresis Development Environment."
...
echo ""
echo "OK! Well done! We have finished! Now just start your eiresis environment with rails s and if something goes wrong please blame the developer."
