namespace :eiresis do
    ...
    desc 'Setup eiresis Environment'
    task :setup do
      puts "          _               _"
      puts "     /\\   (_)             (_)"
      ...
      puts ""
      puts "=====Welcome in eiresis Setup====="
      puts "=================================="
      puts ""
      puts "We'll ask you some information to help you configure your eiresis Development Environment."
      ...
      puts ""
      puts "OK! Well done! We have finished! Now just start your eiresis environment with rails s and if something goes wrong please blame the developer."
